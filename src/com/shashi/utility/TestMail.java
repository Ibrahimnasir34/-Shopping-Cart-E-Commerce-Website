...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "TechWorld.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to TechWorld</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with TechWorldElectronics.<br>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 $ for the first product purchase. To avail this offer you only have "
					+ "to enter the promo code given below.<br><br> PROMO CODE: "
					+ "<span class='greenText'>TechWorld</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
